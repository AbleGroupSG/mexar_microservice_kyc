    ...
    private function sendToMexar(): void
    {
        $data = [
            ...
            'payload' => [
                ...
                'status' => $this->status,
                'verified_at' => $this->status === KycStatuseEnum::APPROVED ? now()->format('Y-m-d\TH:i:s.v\Z') : null,
                'rejected_at' => $this->status === KycStatuseEnum::REJECTED ? now()->format('Y-m-d\TH:i:s.v\Z') : null,
